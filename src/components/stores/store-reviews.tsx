...
export function StoreReviews({ storeId, reviews, canReview, existingRating }: StoreReviewsProps) {
  const avg =
    reviews.length > 0
  ...
  return (
    <div className="space-y-5">
      <h2 className="font-display text-xl sm:text-2xl font-semibold text-primary">
        Reviews
        {reviews.length > 0 && (
          <span className="text-muted text-base font-normal"> ({reviews.length})</span>
        )}
      </h2>
        ...
        <div className="bg-white rounded-2xl border border-border p-5">
          <div className="flex items-center gap-6">
            <div className="text-center">
              <p className="font-display text-5xl font-semibold text-primary">{avg.toFixed(1)}</p>
