              ...
              <div className="bg-white rounded-2xl border border-border p-5">
                ...
                <div className="flex items-end justify-between mb-5">
                  ...
                  <div className="text-right">
                    <p className="text-xs text-muted uppercase tracking-wider mb-1">Condition</p>
                    <p className="text-lg font-semibold text-foreground">{conditionLabel}</p>
                    <p className="text-xs text-muted mt-0.5">{timeAgo(new Date(listing.createdAt))}</p>
                  </div>
                </div>
