...
const LISTINGS = [
  {
    ...
    alt: 'Stack of university textbooks on a wooden desk',
    currentBid: 450,
    minBid: 300,
    seller: 'Priya M.',
    sellerAvatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=60&auto=format&fit=crop",
    rating: 4.8,
    reviews: 12,
    timeLeft: '2h 14m',
    bids: 5,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1733141731756-2d817614a15f?w=600&auto=format&fit=crop",
    alt: 'Badminton racket on gym floor with shuttlecock',
    currentBid: 650,
    minBid: 400,
    seller: 'Marcus T.',
    sellerAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=60&auto=format&fit=crop",
    rating: 4.6,
    reviews: 8,
    timeLeft: '5h 32m',
    bids: 3,
  ...
  },
  {
    ...
    alt: 'MacBook charger cable on clean white surface',
    currentBid: 1200,
    minBid: 900,
    seller: 'Jordan K.',
    sellerAvatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=60&auto=format&fit=crop",
    rating: 5.0,
    reviews: 21,
    timeLeft: '1h 08m',
    bids: 9,
  ...
  },
  {
    ...
    alt: 'Yoga mat on gym floor',
    currentBid: 350,
    minBid: 250,
    seller: 'Aisha N.',
    sellerAvatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=60&auto=format&fit=crop",
    rating: 4.9,
    reviews: 6,
    timeLeft: '12h 00m',
    bids: 2,
